...
log_directory = os.path.dirname(os.path.realpath(__file__)) + "/dqn-log-" + args.id + "-" +  datestr + "/"
model_directory = os.path.dirname(os.path.realpath(__file__)) + "/dqn-models-" + args.id + "-" + datestr + "/"
